            ...
            Column(
              ...
              children: [
                ...
                const Padding(
                  ...
                  child: Text('CRYPTO VAULT',style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.bold,letterSpacing: 5),)
                ),
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Text('WELCOME TO CRYPTO VAULT.',style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.w800)),
                        ),
                        Padding(
